 ...
 *  68             |  PA1   | "CANRX"
 *  69             |  PA0   | "CANTX"
 *  70             |  PA17  | "SDA1" // Wire1 전용
 *  71             |  PA18  | "SCL1" // Wire1 전용
...
extern const PinDescription g_APinDescription[]=
{
  ...
  { PIOB, PIO_PB4,          ID_PIOB, PIO_INPUT, PIO_PULLUP, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER  }, // PIN 99 -> 6
  { PIOB, PIO_PB5,          ID_PIOB, PIO_INPUT, PIO_PULLUP, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 100 -> 7
  { PIOB, PIO_PB6,          ID_PIOB, PIO_INPUT, PIO_PULLUP, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 101 -> 8
  { PIOB, PIO_PB7,          ID_PIOB, PIO_INPUT, PIO_PULLUP, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 102 -> 9
  // 10
  ...
  { PIOB, PIO_PB22,         ID_PIOB, PIO_INPUT, PIO_PULLUP, PIN_ATTR_DIGITAL,                      NO_ADC, NO_ADC, NOT_ON_PWM, NOT_ON_TIMER }, // PIN 103 b상 kbg 250403 
  // 20/21 - TWI1
  ...
  { PIOB, PIO_PB23,           ID_PIOB, PIO_INPUT, PIO_PULLUP, PIN_ATTR_DIGITAL,                               NO_ADC, NO_ADC, NOT_ON_PWM, NOT_ON_TIMER }, // kbg 250403 z상
  ...
  { PIOB, PIO_PB0,          ID_PIOB, PIO_INPUT, PIO_PULLUP, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 95 -> 43
  { PIOB, PIO_PB1,          ID_PIOB, PIO_INPUT, PIO_PULLUP, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 96 -> 44
  { PIOB, PIO_PB2,          ID_PIOB, PIO_INPUT, PIO_PULLUP, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 97 -> 45

  // 46
  { PIOB, PIO_PB3,          ID_PIOB, PIO_INPUT, PIO_PULLUP, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 98 -> 46
  ...
  ///////////////////////////////// 92 - 107 User Define pins 20250318_KS ///////////////////////////////////////////////
  ...
  { PIOC, PIO_PC17,          ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 46 -> 94
  { PIOC, PIO_PC18,          ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 95
  { PIOC, PIO_PC19,          ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 96
  { PIOC, PIO_PC20,          ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 97 bgk 250331 
  { PIOC, PIO_PC21B_PWML4,   ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, PWM_CH4,     NOT_ON_TIMER }, // PWML4 -> 98
  { PIOC, PIO_PC22B_PWML5,   ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, PWM_CH5,     NOT_ON_TIMER }, // PWML5 -> 99
  { PIOC, PIO_PC23B_PWML6,   ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, PWM_CH6,     NOT_ON_TIMER }, // PWML6 7 -> 100
  { PIOC, PIO_PC24B_PWML7,   ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, PWM_CH7,     NOT_ON_TIMER }, // PWML7 6 -> 101
  // END
